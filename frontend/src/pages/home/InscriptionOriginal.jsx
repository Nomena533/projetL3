...
export default function Inscription() {
  ...
  const { instruments, setInstruments } = useInstrument();
  ...
  const montantTotal = useMemo(
    () => nombreInstruments * MONTANT_PAR_INSTRUMENT,
    [nombreInstruments],
  );
          ...
          {sent ? (
            <div className="flex flex-col items-center gap-3 py-10 text-center animate-fade-in">
              ...
              <p className="max-w-sm font-body text-sm text-ink-soft">
                ...
                {niveau.nom} pour {nombreInstruments} instrument
