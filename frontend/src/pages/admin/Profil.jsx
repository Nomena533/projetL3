...
export default function AdminProfil() {
  ...
  const initials = user ? `${user.firstname?.[0] || ""}${user.name?.[0] || ""}`.toUpperCase() : "AD";
  ...
  return (
    <div className="space-y-8">
      <AnimatedSection>
        ...
        <p className="mt-2 font-body text-sm text-ink-soft">Informations de ton compte administrateur.</p>
      </AnimatedSection>

      <div className="grid gap-6 lg:grid-cols-2">
        <AnimatedSection delay={60}>
          <SettingsSection icon={HiOutlineUserCircle} title="Photo de profil" description="Affichée dans la barre latérale de l'administration.">
            <div className="flex items-center gap-4 py-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input id="admin-profile-photo" type="file" accept="image/*" className="sr-only" />
      ...
      <AnimatedSection delay={140}>
        <SettingsSection icon={HiOutlineIdentification} title="Informations personnelles" description="Ton identité sur la plateforme.">
          <div className="grid gap-4 py-5 sm:grid-cols-2">
          ...
          <div className="flex items-center gap-2 border-t border-ivory-dark py-4 font-body text-sm text-ink-soft">
            <HiOutlineShieldCheck size={16} className="text-emerald-600" />
            Rôle : Administrateur
          </div>
        </SettingsSection>
      </AnimatedSection>
